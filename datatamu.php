...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			echo '<li class="active"><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Data Tamu</a></li>';
...
<div class="container">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">Data Tamu</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th align="center" style="vertical-align:top">No</th>
                  <th align="center" style="vertical-align:top">Nama</th>
				  <th align="center" style="vertical-align:top">Instansi</th>
                  <th align="center" style="vertical-align:top">Alamat</th>
				  <th align="center" style="vertical-align:top">No HP/Telp</th>
                  <th align="center" style="vertical-align:top">Keperluan</th>
				  <th align="center" style="vertical-align:top">Pengisi</th>
				  <?php
				  if(!isset($_GET["mode"]))
				  {
				  }
              ...
              <tbody>
				...
				{
				$query = mysqli_query($connection, "SELECT * FROM datatamu");
				...
				while($row = mysqli_fetch_assoc($query)) {
					...
					echo '<form role="form" method="post" action="deletetamu.php?id='.$row["id"].'">'; 
				...
				$searchquery = mysqli_query($connection, "SELECT * FROM datatamu WHERE nama LIKE '%$searchnama%'");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="post" action="inserttamu.php">
                  ...
                  <div class="form-group">
                      <input name="instansi" type="text" class="form-control"
                          id="instansi" placeholder="Instansi" required/>
                  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                      <input name="telp" type="text" class="form-control"
                          id="telp" placeholder="No HP/Telp" required/>
                  </div>
				  <div class="form-group">
                      <input name="keperluan" type="text" class="form-control"
                          id="keperluan" placeholder="Keperluan" required/>
                  </div>
            </div>
