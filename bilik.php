...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			echo '<li class="active"><a href="#"><span class="glyphicon glyphicon-oil" aria-hidden="true"></span> Bilik Kejujuran</a></li>';
...
<div class="container">
      <div class="row">
		...
		<?php
			...
			echo '<li><a href="?mode=konfirmasi"><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span> Konfirmasi Pengambilan</a></li>';
			}
			echo '<li><a href="?mode=arsip"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span> Arsip</a></li>';
		   }
			?>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">Bilik Kejujuran</h2>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
				  ...
				  if(!isset($_GET["mode"]))
				  {
					echo '<th align="center" style="vertical-align:top">No</th>';
					echo '<th align="center" style="vertical-align:top">Tanggal</th>';
					echo '<th align="center" style="vertical-align:top">Nama Barang</th>';
					echo '<th align="center" style="vertical-align:top">Nama Pelapor</th>';
					echo '<th align="center" style="vertical-align:top">Kelas</th>';
				  }
				  elseif($_GET["mode"] == "arsip")
				  {
					...
					echo '<th align="center" style="vertical-align:top">Nama Pelapor</th>';
					echo '<th align="center" style="vertical-align:top">Kelas</th>';
					echo '<th align="center" style="vertical-align:top">Nama Pengambil</th>';
					echo '<th align="center" style="vertical-align:top"> Kelas</th>';
					echo '<th align="center" style="vertical-align:top">Tanggal Diambil</th>';
					echo '<th align="center" style="vertical-align:top">Status</th>';
				  }
              ...
              <tbody>
				...
				if(!isset($_GET["srch-term"]))
				{
					if(!isset($_GET["mode"]))
					{
					$query = mysqli_query($connection, "SELECT * FROM bilik WHERE konfirmasi='0'");
					...
					elseif($_GET["mode"] == "arsip")
					{
					$query1 = mysqli_query($connection, "SELECT * FROM bilik WHERE konfirmasi='1'");
					...
					echo "</td>";
					echo '<td>';
					echo $row['namapengambil'];
					echo '</td>';
					echo '<td>';
					echo $row['kelaspengambil'];
					echo '</td>';
					echo '<td>';
					...
					elseif($_GET["mode"] == "konfirmasi")
					{
					$query2 = mysqli_query($connection, "SELECT * FROM bilik WHERE konfirmasi=0");
					...
					echo '<form role="form" method="post" action="konfirmasibilik.php?id='.$row["id"].'">'; 
					echo '<h6>Konfirmasi bahwa barang telah diambil oleh pemilik</h6>';
					echo '<div class="form-group">';
                    echo '<input name="namapemilik" type="text" class="form-control" id="namapemilik" placeholder="Nama Pemilik" required/>';
					echo '</div>';
					echo '<div class="form-group">';
                    echo '<input name="kelaspemilik" type="text" class="form-control" id="namapemilik" placeholder="Kelas" required/>';
					echo '</div>';
					echo '</div>';
				...
				} elseif(isset($_GET["srch-term"])) {
				$searchnama = $_GET["srch-term"];
				$searchquery = mysqli_query($connection, "SELECT * FROM bilik WHERE namabarang LIKE '%$searchnama%'");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="post" action="insertbilik.php">
                  <div class="form-group">
                      <input name="namabarang" type="text" class="form-control"
                      id="namabarang" placeholder="Nama Barang" required/>
                  </div>
                  <div class="form-group">
